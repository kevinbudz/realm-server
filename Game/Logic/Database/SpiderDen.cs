    ...
    public class SpiderDen : IBehaviorDatabase
    {
        public void Init(BehaviorDb db)
        {
            ...
            db.Init("Spider Egg Sac",
                ...
                new State("idle",
                    new PlayerWithinTransition(0.5f, "suicide")
                ),
                new State("suicide",
                    new Suicide()
                )
