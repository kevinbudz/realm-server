    ...
    public class Lab : IBehaviorDatabase
    {
        public void Init(BehaviorDb db)
        {
            ...
            db.Init("Red Gas Spawner UL",
                new State("OFF",
                    new ConditionalEffect(ConditionEffectIndex.Invincible), new EntityNotExistsTransition("Dr Terrible", 50, "OFF")),
                new State("ON",
                    new ConditionalEffect(ConditionEffectIndex.Invincible),
                    new Shoot(10, count: 20, index: 0, fixedAngle: 22.5f), new EntityNotExistsTransition("Dr Terrible", 50, "OFF")));
