...
namespace RotMG.Game.DungeonGen.Templates.Lab
{
    public class LabTemplate : DungeonTemplate
    {
        ...
        private static readonly DungeonObject _web = new DungeonObject
        {
            ObjectType = Web
        };
        ...
        private bool _generatedEvilRoom;

        public override void Initialize()
        {
            _targetDepth = new NormDist(3, 10, 7, 15, Rand.Next());
            _generatedEvilRoom = false;
        }
        ...
        {
            NormalRoom rm = new NormalRoom(prev as NormalRoom, Rand, _generatedEvilRoom);
            if ((rm.Flags & NormalRoom.RoomFlags.Evil) != 0)
                _generatedEvilRoom = true;
            return rm;
        }
