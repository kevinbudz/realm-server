...
{
    //Ported from realm-src-master wServer/realm/setpieces/TempleB.cs.
    ...
    public class TempleB : Temple
    {
        ...
        public override void RenderSetPiece(World world, IntPoint pos)
        {
            ...
            //Boss & Chest
            SetPieces.PutEntity(world, Chest, pos.X + bas + 11.5f, pos.Y + bas + 11.5f);
            SetPieces.SpawnEnemy(world, Boss, pos.X + bas + 11.5f, pos.Y + bas + 11.5f);
        }
    }
}
